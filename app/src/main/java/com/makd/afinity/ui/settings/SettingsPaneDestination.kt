...
sealed interface SettingsPaneDestination : Parcelable {
    @Parcelize data object Appearance : SettingsPaneDestination

    @Parcelize data object CustomSections : SettingsPaneDestination

    @Parcelize data object Player : SettingsPaneDestination
    ...
    @Parcelize data object QuickConnect : SettingsPaneDestination

    @Parcelize data object ControlPanel : SettingsPaneDestination
}
