...
data class Network(
    val id: Int, val name: String, val logoPath: String?
) {
    companion object {
        fun getPopularNetworks(): List<Network> = listOf(
            Network(id = 213, name = "Netflix", logoPath = "/wwemzKWzjKYJFfCeiB57q3r4Bcm.png"),
            Network(id = 1024, name = "Prime Video", logoPath = "/ifhbNuuVnlwYy5oXA5VIb2YR8AZ.png"),
            ...
            Network(id = 2552, name = "Apple TV+", logoPath = "/4KAy34EHvRM25Ih8wb82AuGU7zJ.png"),
            Network(id = 453, name = "Hulu", logoPath = "/pqUTCleNUiTLAVlelGxUgWn1ELh.png"),
            Network(id = 4353, name = "Discovery+", logoPath = "/1D1bS3Dyw4ScYnFWTlBOvJXC3nb.png"),
            ...
            Network(id = 4330, name = "Paramount+", logoPath = "/fi83B1oztoS47xxcemFdPMhIzK.png"),
            ...
            Network(id = 80, name = "Adult Swim", logoPath = "/9AKyspxVzywuaMuZ1Bvilu8sXly.png"),
