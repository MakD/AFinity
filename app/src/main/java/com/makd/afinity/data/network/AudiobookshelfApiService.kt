...
interface AudiobookshelfApiService {
    ...
    @POST("api/authorize") suspend fun authorize(): Response<AuthorizeResponse>

    @POST("login") suspend fun login(@Body credentials: LoginRequest): Response<LoginResponse>

    @GET("api/libraries") suspend fun getLibraries(): Response<LibrariesResponse>
