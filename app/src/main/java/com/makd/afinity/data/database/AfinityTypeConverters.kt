...
class AfinityTypeConverters {
    ...
    @TypeConverter fun toUUID(uuidString: String?): UUID? = uuidString?.let { UUID.fromString(it) }
    ...
    fun toAfinityMovie(movieString: String?): AfinityMovie? {
        ...
        return try {
            ...
            AfinityMovie(
                ...
                premiereDate =
                    serializable.premiereDate?.let {
                        LocalDateTime.parse(it, DateTimeFormatter.ISO_LOCAL_DATE_TIME)
                    },
                dateCreated =
                    serializable.dateCreated?.let {
                        LocalDateTime.parse(it, DateTimeFormatter.ISO_LOCAL_DATE_TIME)
                    },
        ...
        val serializable =
            SerializableAfinityShow(
                ...
                dateLastContentAdded =
                    show.dateLastContentAdded?.format(DateTimeFormatter.ISO_LOCAL_DATE_TIME),
                genres = show.genres,
    ...
    fun toAfinityShow(showString: String?): AfinityShow? {
        ...
        return try {
            ...
            AfinityShow(
                ...
                dateLastContentAdded =
                    serializable.dateLastContentAdded?.let {
                        LocalDateTime.parse(it, DateTimeFormatter.ISO_LOCAL_DATE_TIME)
                    },
                people = toAfinityPersonList(serializable.peopleJson) ?: emptyList(),
                genres = serializable.genres,
