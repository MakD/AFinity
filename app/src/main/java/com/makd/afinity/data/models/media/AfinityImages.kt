...
fun BaseItemDto.toAfinityImages(
    ...
    return AfinityImages(
        ...
        showLogo = showLogo,
        primaryImageBlurHash = imageBlurHashes?.get(ImageType.PRIMARY)?.get(imageTags?.get(ImageType.PRIMARY)),
        backdropImageBlurHash = imageBlurHashes?.get(ImageType.BACKDROP)?.get(backdropImageTags?.firstOrNull()),
        thumbImageBlurHash = imageBlurHashes?.get(ImageType.THUMB)?.get(imageTags?.get(ImageType.THUMB)),
        logoImageBlurHash = imageBlurHashes?.get(ImageType.LOGO)?.get(imageTags?.get(ImageType.LOGO)),
        showPrimaryImageBlurHash = imageBlurHashes?.get(ImageType.PRIMARY)?.get(seriesPrimaryImageTag),
        showBackdropImageBlurHash = imageBlurHashes?.get(ImageType.BACKDROP)?.get(seriesPrimaryImageTag),
