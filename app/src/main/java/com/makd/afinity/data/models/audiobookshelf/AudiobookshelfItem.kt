...
data class LibraryItem(
    ...
    @SerialName("size")
    val size: Long? = null,
    @SerialName("userMediaProgress")
    val userMediaProgress: MediaProgress? = null,
    @SerialName("rssFeedUrl")
...
data class Media(
    ...
    @SerialName("numMissingParts")
    val numMissingParts: Int? = null,
    @SerialName("numInvalidAudioFiles")
    val numInvalidAudioFiles: Int? = null
)
...
data class MediaMetadata(
    ...
    @SerialName("titleIgnorePrefix")
    val titleIgnorePrefix: String? = null,
    @SerialName("subtitle")
    val subtitle: String? = null,
    @SerialName("authorName")
    val authorName: String? = null,
    @SerialName("authorNameLF")
    ...
    @SerialName("lastCoverSearch")
    val lastCoverSearch: Long? = null,
    @SerialName("lastCoverSearchQuery")
...
data class AudioFile(
    ...
    @SerialName("metaTags")
    val metaTags: AudioMetaTags? = null,
    @SerialName("mimeType")
...
data class SearchResponse(
    @SerialName("book")
    val book: List<SearchResultBook>? = null,
    @SerialName("podcast")
    val podcast: List<SearchResultPodcast>? = null,
    @SerialName("narrators")
    val narrators: List<NarratorResult>? = null,
    @SerialName("authors")
    val authors: List<Author>? = null,
    @SerialName("series")
    val series: List<SeriesResult>? = null,
    @SerialName("tags")
    val tags: List<String>? = null
)
...
data class SearchResultBook(
    @SerialName("libraryItem")
    val libraryItem: LibraryItem,
    @SerialName("matchKey")
    val matchKey: String? = null,
    @SerialName("matchText")
