...
data class UserPermissions(
    @SerialName("download") val download: Boolean? = null,
    @SerialName("update") val update: Boolean? = null,
    @SerialName("delete") val delete: Boolean? = null,
    @SerialName("upload") val upload: Boolean? = null,
    @SerialName("accessAllLibraries") val accessAllLibraries: Boolean? = null,
    @SerialName("accessAllTags") val accessAllTags: Boolean? = null,
    @SerialName("accessExplicitContent") val accessExplicitContent: Boolean? = null,
)
...
data class LoginResponse(
    @SerialName("user") val user: AudiobookshelfUser,
    @SerialName("userDefaultLibraryId") val userDefaultLibraryId: String? = null,
    @SerialName("serverSettings") val serverSettings: ServerSettings? = null,
    @SerialName("ereaderDevices") val ereaderDevices: List<String>? = null,
)
...
data class ServerSettings(
    ...
    @SerialName("metadataFileFormat") val metadataFileFormat: String? = null,
    @SerialName("rateLimitLoginRequests") val rateLimitLoginRequests: Int? = null,
    @SerialName("rateLimitLoginWindow") val rateLimitLoginWindow: Int? = null,
    ...
    @SerialName("loggerDailyLogsToKeep") val loggerDailyLogsToKeep: Int? = null,
    @SerialName("loggerScannerLogsToKeep") val loggerScannerLogsToKeep: Int? = null,
    ...
    @SerialName("sortingPrefixes") val sortingPrefixes: List<String>? = null,
