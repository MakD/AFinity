...
data class Library(
    ...
    @SerialName("settings") val settings: LibrarySettings? = null,
    @SerialName("stats") val stats: LibraryStats? = null,
...
data class LibraryStats(
    ...
    @SerialName("totalDuration") val totalDuration: Double? = null,
    @SerialName("numAudioFiles") val numAudioFiles: Int? = null,
    @SerialName("numAudioTracks") val numAudioTracks: Int? = null,
)

@Serializable data class LibrariesResponse(@SerialName("libraries") val libraries: List<Library>)

@Serializable
data class LibraryResponse(
    @SerialName("library") val library: Library? = null,
    @SerialName("issues") val issues: Int? = null,
    @SerialName("numUserPlaylists") val numUserPlaylists: Int? = null,
    @SerialName("filterData") val filterData: FilterData? = null,
)

@Serializable
data class FilterData(
    @SerialName("authors") val authors: List<AuthorFilter>? = null,
    @SerialName("genres") val genres: List<String>? = null,
    @SerialName("tags") val tags: List<String>? = null,
    @SerialName("series") val series: List<SeriesFilter>? = null,
...
@Serializable
data class AuthorFilter(@SerialName("id") val id: String, @SerialName("name") val name: String)

@Serializable
data class SeriesFilter(@SerialName("id") val id: String, @SerialName("name") val name: String)

@Serializable
data class LibraryItemsResponse(
    @SerialName("results") val results: List<LibraryItem>,
    @SerialName("total") val total: Int,
    @SerialName("limit") val limit: Int,
    @SerialName("page") val page: Int,
    @SerialName("sortBy") val sortBy: String? = null,
    @SerialName("sortDesc") val sortDesc: Boolean? = null,
    @SerialName("filterBy") val filterBy: String? = null,
    @SerialName("mediaType") val mediaType: String? = null,
    @SerialName("minified") val minified: Boolean? = null,
    @SerialName("collapseseries") val collapseseries: Boolean? = null,
    @SerialName("include") val include: String? = null,
)
...
data class AudiobookshelfSeries(
    @SerialName("id") val id: String,
    @SerialName("name") val name: String,
    @SerialName("nameIgnorePrefix") val nameIgnorePrefix: String? = null,
...
data class SeriesListResponse(
    @SerialName("results") val results: List<AudiobookshelfSeries>,
    @SerialName("total") val total: Int,
    @SerialName("limit") val limit: Int,
    @SerialName("page") val page: Int,
    @SerialName("sortBy") val sortBy: String? = null,
...
data class PersonalizedView(
    ...
    @SerialName("labelStringKey") val labelStringKey: String? = null,
    @SerialName("type") val type: String,
    @SerialName("entities") val entities: JsonArray = JsonArray(emptyList()),
)
