...
internal object PortablePreferences {
    ...
    val specs: List<PrefSpec> =
        listOf(
            ...
            spec("video_zoom_mode", PrefType.STRING, SettingsSection.PLAYBACK),
            ...
            spec("subtitle_text_size", PrefType.INT, SettingsSection.SUBTITLES),
            ...
            spec("subtitle_outline_size", PrefType.INT, SettingsSection.SUBTITLES),
            ...
            spec("sync_interval", PrefType.LONG, SettingsSection.DOWNLOADS),
            ...
            spec("update_check_frequency", PrefType.STRING, SettingsSection.PRIVACY),
        )
