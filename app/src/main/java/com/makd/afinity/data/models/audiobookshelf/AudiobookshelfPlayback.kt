...
data class PlaybackSessionRequest(
    ...
    @SerialName("forceDirectPlay")
    val forceDirectPlay: Boolean? = null,
    @SerialName("forceTranscode")
    val forceTranscode: Boolean? = null,
    @SerialName("supportedMimeTypes")
...
data class BatchLocalSessionRequest(
    @SerialName("sessions")
    val sessions: List<LocalSessionData>
)
...
data class BatchSyncResponse(
    @SerialName("results")
    val results: List<BatchSyncResult>? = null,
    @SerialName("numSuccessful")
    val numSuccessful: Int? = null,
    @SerialName("numFailed")
    val numFailed: Int? = null
)
